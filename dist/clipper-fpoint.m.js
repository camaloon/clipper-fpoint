...
ClipperLib.Clipper.prototype.SetZ = function (pt, e1, e2) {
    if (this.ZFillFunction !== null) {
        if (pt.Z !== 0 || this.ZFillFunction === null) 
            { return; }
         else if (ClipperLib.FPoint_op_Equality(pt, e1.Bot)) 
            { pt.Z = e1.Bot.Z; }
         else if (ClipperLib.FPoint_op_Equality(pt, e1.Top)) 
            { pt.Z = e1.Top.Z; }
         else if (ClipperLib.FPoint_op_Equality(pt, e2.Bot)) 
            { pt.Z = e2.Bot.Z; }
         else if (ClipperLib.FPoint_op_Equality(pt, e2.Top)) 
            { pt.Z = e2.Top.Z; }
         else 
...
ClipperLib.Clipper.prototype.AddLocalMinPoly = function (e1, e2, pt) {
    ...
    if (prevE !== null && prevE.OutIdx >= 0 && prevE.Top[1] < pt[1] && e.Top[1] < pt[1]) {
        ...
        if (xPrev === xE && e.WindDelta !== 0 && prevE.WindDelta !== 0 && ClipperLib.ClipperBase.SlopesEqual5([xPrev,
            pt[1]], prevE.Top, [xE,pt[1]], e.Top)) {
                ...
                if (dir === ClipperLib.Direction.dLeftToRight) {
                    while (currMax !== null && currMax[0] < e.Curr[0]) {
                        if (horzEdge.OutIdx >= 0 && !IsOpen) {
                            this$1.AddOutPt(horzEdge, [currMax[0],horzEdge.Bot[1]]);
                        }
                        currMax = currMax.Next;
                    }
                } else {
...
ClipperLib.Clipper.prototype.FixupOutPolygon = function (outRec) {
    ...
    for (; ; ) {
        ...
        if (ClipperLib.FPoint_op_Equality(pp.Pt, pp.Next.Pt) || ClipperLib.FPoint_op_Equality(pp.Pt, pp.Prev.Pt) || ClipperLib.ClipperBase.SlopesEqual4(pp.Prev.Pt, pp.Pt, pp.Next.Pt) && (!preserveCol || !this$1.Pt2IsBetweenPt1AndPt3(pp.Prev.Pt, pp.Pt, pp.Next.Pt))) {
            lastOK = null;
...
ClipperLib.ClipperOffset.prototype.DoOffset = function (delta) {
    ...
    for (var i = 0;i < this.m_polyNodes.ChildCount(); i++) {
        ...
        if (len === 1) {
            if (node.m_jointype === ClipperLib.JoinType.jtRound) {
                ...
                for (var j = 1;j <= steps; j++) {
                    this$1.m_destPoly.push([this$1.m_srcPoly[0][0] + X * delta,this$1.m_srcPoly[0][1] + Y * delta]);
                    var X2 = X;
        ...
        if (node.m_endtype === ClipperLib.EndType.etClosedLine || node.m_endtype === ClipperLib.EndType.etClosedPolygon) 
            ...
            { this$1.m_normals.push([].concat( this$1.m_normals[len - 2] )); }
        if (node.m_endtype === ClipperLib.EndType.etClosedPolygon) {
            var k = len - 1;
            for (var j = 0;j < len; j++) 
            ...
            for (var j = len - 1;j > 0; j--) 
                { this$1.m_normals[j] = [-this$1.m_normals[j - 1][0],-this$1.m_normals[j - 1][1]]; }
            this$1.m_normals[0] = [-n[0],-n[1]];
            k = 0;
            for (var j = len - 1;j >= 0; j--) 
                { k = this$1.OffsetPoint(j, k, node.m_jointype); }
            this$1.m_destPolys.push(this$1.m_destPoly);
            ...
            if (node.m_endtype === ClipperLib.EndType.etOpenButt) {
                var j = len - 1;
                pt1 = [this$1.m_srcPoly[j][0] + this$1.m_normals[j][0] * delta,this$1.m_srcPoly[j][1] + this$1.m_normals[j][1] * delta];
                ...
                k = len - 2;
                this$1.m_sinA = 0;
                this$1.m_normals[j] = [-this$1.m_normals[j][0],-this$1.m_normals[j][1]];
            ...
            for (var j = len - 1;j > 0; j--) 
                { this$1.m_normals[j] = [-this$1.m_normals[j - 1][0],-this$1.m_normals[j - 1][1]]; }
            this$1.m_normals[0] = [-this$1.m_normals[1][0],-this$1.m_normals[1][1]];
            k = len - 1;
            for (var j = k - 1;j > 0; --j) 
                { k = this$1.OffsetPoint(j, k, node.m_jointype); }
            if (node.m_endtype === ClipperLib.EndType.etOpenButt) {
                pt1 = [this$1.m_srcPoly[0][0] - this$1.m_normals[0][0] * delta,this$1.m_srcPoly[0][1] - this$1.m_normals[0][1] * delta];
                this$1.m_destPoly.push(pt1);
                pt1 = [this$1.m_srcPoly[0][0] + this$1.m_normals[0][0] * delta,this$1.m_srcPoly[0][1] + this$1.m_normals[0][1] * delta];
                this$1.m_destPoly.push(pt1);
            } else {
...
ClipperLib.ClipperOffset.prototype.DoRound = function (j, k) {
    ...
    for (var i = 0;i < steps; ++i) {
        this$1.m_destPoly.push([this$1.m_srcPoly[j][0] + X * this$1.m_delta,this$1.m_srcPoly[j][1] + Y * this$1.m_delta]);
        X2 = X;
        X = X * this$1.m_cos - this$1.m_sin * Y;
        Y = X2 * this$1.m_sin + Y * this$1.m_cos;
    }
